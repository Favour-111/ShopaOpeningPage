...
const Info = () => {
  ...
  return (
    <div
      className="sm:bg-contain bg-cover bg-center bg-no-repeat sm:mt-10 mt-0 h-auto sm:py-16 py-16 px-4 sm:px-6 md:px-10"
    ...
    >
      <div className="px-2 sm:px-6 md:px-10">
        ...
        <p className="text-[#787878] text-sm sm:text-base mt-3 w-full sm:w-[90%] md:w-[83%] text-center mx-auto">
          Whether you’re a buyer or a seller in a university community, Shopa is
          built for you.
        </p>
